...
parser.add_argument('--data_path',                 type=str,   help='path to the data', default='/home/wangshuo/')
parser.add_argument('--gt_path',                   type=str,   help='path to the groundtruth data', default='/home/wangshuo/')
parser.add_argument('--filenames_file',            type=str,   help='path to the filenames text file',default='/home/wangshuo/dou/NeWCRFs/log/log.txt')
...
parser.add_argument('--gt_path_eval',              type=str,   help='path to the groundtruth data for online evaluation',default=1e-3)
